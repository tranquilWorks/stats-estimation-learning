# P19 walkthrough: Track a Hidden State with a Kalman Filter

## Planned learner sequence

1. Read the guiding question: What inputs, observable effects, and failure modes matter when you track a Hidden State with a Kalman Filter?
