# P20 checks: Approximate a Nonlinear Posterior with Particles
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you approximate a Nonlinear Posterior with Particles?” without relying on MATLAB syntax.
