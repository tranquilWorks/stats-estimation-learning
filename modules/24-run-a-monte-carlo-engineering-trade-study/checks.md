# P24 checks: Run a Monte Carlo Engineering Trade Study
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you run a Monte Carlo Engineering Trade Study?” without relying on MATLAB syntax.
