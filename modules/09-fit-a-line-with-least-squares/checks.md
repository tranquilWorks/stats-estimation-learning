# P09 checks: Fit a Line with Least Squares
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you fit a Line with Least Squares?” without relying on MATLAB syntax.
