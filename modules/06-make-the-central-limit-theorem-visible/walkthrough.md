# P06 walkthrough: Make the Central Limit Theorem Visible

## Planned learner sequence

1. Read the guiding question: What inputs, observable effects, and failure modes matter when you make the Central Limit Theorem Visible?
