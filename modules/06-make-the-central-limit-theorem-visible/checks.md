# P06 checks: Make the Central Limit Theorem Visible
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you make the Central Limit Theorem Visible?” without relying on MATLAB syntax.
